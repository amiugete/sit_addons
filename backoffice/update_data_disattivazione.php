...
$result_usit0 = pg_execute($conn_sit, "update_sit0", array($data_disatt, $cod_percorso)); 
if (!pg_last_error($conn_sit)){
    #$res_ok=0;
} else {
    pg_last_error($conn_sit);
...
$result_usit1 = pg_execute($conn_sit, "update_sit1", array($data_disatt, $cod_percorso)); 
...
$result_usit2 = pg_execute($conn_sit, "update_sit2", array($data_disatt, $cod_percorso)); 
if (!pg_last_error($conn_sit)){
    #$res_ok=0;
} else {
    pg_last_error($conn_sit);
...
$result_usit3 = pg_execute($conn_sit, "update_sit3", array($data_disatt, $cod_percorso)); 
if (!pg_last_error($conn_sit)){
    #$res_ok=0;
} else {
    pg_last_error($conn_sit);
...
$result_usit4 = pg_execute($conn_sit, "update_sit4", array($data_disatt, $cod_percorso)); 
if (!pg_last_error($conn_sit)){
    #$res_ok=0;
} else {
    pg_last_error($conn_sit);
