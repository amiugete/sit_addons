...
<div class="banner"> <div id="banner-image"></div> </div>
      <div class="container">
            ...
            <hr>
            <h5> Disegnare l'area sulla mappa prima di inviare la richiesta di estrazione utenze (<a href="https://lizmap-editing-manuale.readthedocs.io/it/latest/istruzioni.html" target="_blank"> DOCUMENTAZIONE </a>)</h5>
            <div class="row">
              <iframe src="https://amiugis.amiu.genova.it/mappe/lizmap/www/index.php/view/map?repository=repository1&project=utenze_ecopunti_iframe" 
              title="Disegna area per estrazione utenze\" style="height:500px;" allowfullscreen></iframe>
            </div>
              <hr> 
            <form name="openfile" method="post" autocomplete="off" action="./backoffice/utenze_ecopunti_output.php" >
            ...
            <label for="eco">Area ecopunto:</label> <font color="red">*</font>
            <select class="form-control" name="eco" id="eco">
                <option name="naz" value="" > Scegli un'area</option>
            <?php            
            $query2="SELECT * From etl.aree_ecopunti_4326 where data_disegno::date>=(NOW() - INTERVAL '30' DAY) order by data_disegno desc;";
...
function refreshSelect() {
  ...
  fetch("./index_ecopunti_refresh_select.php")
